      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
        <div className="text-center md:text-left">
          ...
          <p className="text-xl sm:text-2xl text-foreground mb-6">
            Full Stack Developer | MERN | Python | DevOps | Cloud | AI/ML Enthusiast
          </p>
          <p className="text-lg text-muted-foreground mb-8">
            Crafting innovative and scalable solutions to bring ideas to life. Passionate about technology and continuous learning.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg transition-transform hover:scale-105">
              <a href="/resume.pdf" download="Saravanan_Resume.pdf">
